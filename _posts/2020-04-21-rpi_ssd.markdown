...
__Step1: download and install rpi-clone__
...
__Step 3: clone your SD card to USB disk, and tell the SD card to boot from disk__
...
__Step4: reboot your pi__

    $ sudo reboot


__Step 5 (optional): boot directly from SSD, without SD card__
